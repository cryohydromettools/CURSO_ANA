...
## Input - Output path
INPUT_NAME = '../testdata/MSM_1m_testdata.nc'
OUTPUT_NAME = './output/MSM_testout_pot.nc'
...
#### read in SVF
dsSVF = xr.open_dataset('../testdata/LUT_SVFdir45.nc')    # path to the look-up table of directed sky-view factors
LUT_SVF = dsSVF.SVFdir                # look-up table of directed sky-view factors (can be created with the script LUT_SVFdir45.py)

#### read in Wind data
Wind = pd.read_csv('../testdata/Wind_1m.csv')
